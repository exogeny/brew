...
# HOMEBREW_VENDOR, HOMEBREW_LIBRUBY set by bin/brew
# shellcheck disable=SC2154
export HOMEBREW_REQUIRED_RUBY_VERSION="3.3"
HOMEBREW_PORTABLE_RUBY_VERSION="$(cat "${HOMEBREW_VENDOR_PATH}/portable-ruby-version")"
...
test_ruby() {
  ...
  "$1" --enable-frozen-string-literal --disable=gems,did_you_mean,rubyopt \
    "${HOMEBREW_LIBRUBY}/utils/ruby_check_version_script.rb" \
...
"
  ...
  vendor_dir="${HOMEBREW_VENDOR:-${HOMEBREW_REPOSITORY}/vendor}"
